...
export default function SourcesPage() {
  ...
  return (
    <main className="mx-auto max-w-5xl px-5 py-8 sm:px-6 sm:py-12" data-testid="sources-page">
      ...
      {error ? (
        <div className="card mt-8 p-5" data-testid="sources-error">
      ...
      {!loading && !error && sources.length === 0 ? (
        <div className="card mt-8 p-8 text-center" data-testid="sources-empty">
      ...
      {!loading && !error ? (
        <section className="card mt-8 p-5" data-testid="add-source">
